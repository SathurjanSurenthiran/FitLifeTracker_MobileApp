...
const styles = StyleSheet.create({
  ...
  catSummaryRow: { flexDirection: 'row', gap: SIZES.xs, marginTop: 4 },
  catSummaryChip: { flex: 1, flexDirection: 'row', backgroundColor: COLORS.surfaceLight, borderRadius: SIZES.radiusMd, padding: SIZES.xs + 2, gap: 5, alignItems: 'center', borderWidth: 1, borderColor: COLORS.surfaceBorder },
  catSummaryIcon: { width: 26, height: 26, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  catSummaryVal: { fontSize: SIZES.fontSm, fontWeight: '800' },
  catSummaryLbl: { color: COLORS.textMuted, fontSize: 9, fontWeight: '500' },
